...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader = get_data_loaders_v1(
    ...
    trainer.save_checkpoint("models/checkpoints/model_v1.ckpt")
