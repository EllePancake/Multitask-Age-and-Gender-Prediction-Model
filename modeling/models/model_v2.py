...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader = get_data_loaders_v2(
    ...
    trainer.save_checkpoint("models/checkpoints/model_v2.ckpt")
